-- Split eligibility checks so operational failures remain diagnosable without
-- leaking candidate or process details through the public application action.
