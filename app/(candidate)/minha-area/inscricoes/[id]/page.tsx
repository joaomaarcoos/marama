...
export default async function CandidateApplicationPage({ params }: { params: { id: string } }) {
  ...
  const [{ data: vacancies }, { data: preferences }, { data: questionRows }, { data: answerRows }] = await Promise.all([
