...
import { formatSigecAnswer, formatSigecDate, type SigecApplicationDetail } from '@/lib/sigec-application-detail'
...
export function SigecApplicationReviewDetail({ detail }: { detail: SigecApplicationDetail }) {
