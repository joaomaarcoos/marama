...
export type SigecQuestionRow = {
  ...
  question_type: string; required: boolean; config: { audience?: SigecAudience; options?: string[] }; position: number
}
