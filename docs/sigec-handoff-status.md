...
**Fase atual:** `SIGEC-P4-03` concluída na branch `codex/sigec-p4-03-condicionais`; Gate P2 permanece adiado pelas confirmações normativas e pela importação oficial
**Progresso auditado:** 36 de 88 tarefas concluídas; 52 pendentes
...
Prosseguir com `SIGEC-P4-04`, validando no servidor e no banco todos os requisitos obrigatórios antes do envio da candidatura. Para fechar posteriormente o Gate P2, ainda será necessário revisar a prévia real, importar as 364 linhas prontas, corrigir ou excluir as 25 pendentes, finalizar e registrar as seis decisões exigidas pelo gate e confirmar a versão oficial de pontuação/desempates. Até lá, o banco rejeita corretamente a publicação e a classificação automática permanece fechada.
