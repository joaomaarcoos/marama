...
**Fase atual:** Fase 6 em execução na branch `codex/sigec-p6-09-dupla-confirmacao`; `SIGEC-P6-09` concluída fora da ordem por ser independente; `SIGEC-P6-05` aguarda confirmação da ordem oficial dos desempates
**Progresso auditado:** 52 de 88 tarefas concluídas; 36 pendentes
...
Manter `SIGEC-P6-05` pendente até a confirmação da ordem oficial dos desempates; não transformar a referência do edital antigo em regra definitiva. P6-06, P6-07 e P6-08 continuam fechadas porque classificação, listas e cotas dependem dessas decisões. A P6-09 já protege antecipadamente a futura publicação, mas não cria nem publica resultados. Para fechar posteriormente o Gate P2, ainda será necessário revisar a prévia real, importar as 364 linhas prontas, corrigir ou excluir as 25 pendentes e finalizar as decisões normativas. A criação/publicação do primeiro processo seletivo real dentro do SIGEC permanece manual e condicionada aos gates.
