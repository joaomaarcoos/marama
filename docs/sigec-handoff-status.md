...
**Fase atual:** Fase 2 em execução na branch `codex/sigec-fase-2-configuracao-processo`; próximo alvo: SIGEC-P2-06
**Progresso auditado:** 25 de 88 tarefas concluídas; 63 pendentes
...
Executar o SIGEC-P2-06 na branch atual: configurar critérios de pontuação e desempate com versionamento e bloqueio após publicação, mantendo a rubrica provisória separada das regras oficiais ainda pendentes. A prévia real de vagas deve ser revisada por um administrador antes de importar as 364 linhas prontas e corrigir ou excluir as 25 pendentes. Antes de abrir o cadastro público, publicar e validar um processo real pelo Gate P2. A publicação do processo e a classificação oficial continuam bloqueadas enquanto as seis decisões normativas estiverem abertas.
