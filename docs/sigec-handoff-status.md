...
**Fase atual:** Fase 6 em execução na branch `codex/sigec-p6-04-nota-total`; `SIGEC-P6-04` concluída; `SIGEC-P6-05` aguarda confirmação da ordem oficial dos desempates
**Progresso auditado:** 51 de 88 tarefas concluídas; 37 pendentes
...
Manter `SIGEC-P6-05` pendente até a confirmação da ordem oficial dos desempates; não transformar a referência do edital antigo em regra definitiva. Enquanto isso, a nota consolidada pode ser analisada, mas a classificação automática e os snapshots de ranking permanecem fechados. Para fechar posteriormente o Gate P2, ainda será necessário revisar a prévia real, importar as 364 linhas prontas, corrigir ou excluir as 25 pendentes e finalizar as decisões normativas. A criação/publicação do primeiro processo seletivo real dentro do SIGEC permanece manual e condicionada aos gates.
