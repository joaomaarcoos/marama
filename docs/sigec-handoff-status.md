...
**Fase atual:** Fase 6 em execução na branch `codex/sigec-p6-03-producao-academica`; `SIGEC-P6-03` concluída e próxima implementação é `SIGEC-P6-04`; Gate P2 permanece adiado pelas confirmações normativas e pela importação oficial
**Progresso auditado:** 50 de 88 tarefas concluídas; 38 pendentes
...
Iniciar `SIGEC-P6-04`, calculando no servidor/banco a nota consolidada de titulação, experiência e produção, com teto de 100 e snapshots auditáveis dos componentes. Para fechar posteriormente o Gate P2, ainda será necessário revisar a prévia real, importar as 364 linhas prontas, corrigir ou excluir as 25 pendentes, finalizar e registrar as seis decisões exigidas pelo gate e confirmar a versão oficial de pontuação/desempates. A criação/publicação do primeiro processo seletivo real dentro do SIGEC permanece manual e condicionada aos gates; a classificação automática continua fechada.
