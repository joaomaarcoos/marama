...
**Fase atual:** Fase 2 em execução na branch `codex/sigec-fase-2-configuracao-processo`; próximo alvo: SIGEC-P2-05
**Progresso auditado:** 24 de 88 tarefas concluídas; 64 pendentes
...
Executar o SIGEC-P2-05 na branch atual: configurar etapas, transições permitidas e mensagens públicas/WhatsApp. A prévia real de vagas deve ser revisada por um administrador antes de importar as 364 linhas prontas e corrigir ou excluir as 25 pendentes. Em seguida, avançar por pontuação e desempates versionados. Antes de abrir o cadastro público, publicar e validar um processo real pelo Gate P2. A publicação do processo e a classificação oficial continuam bloqueadas enquanto as seis decisões normativas estiverem abertas.
