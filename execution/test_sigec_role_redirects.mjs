...
try {
  ...
  response = await request('/sigec-candidaturas/00000000-0000-0000-0000-000000000000', attendant)
  assert(response.status === 307 && locationPath(response) === '/dashboard', 'attendant_sigec_application_detail_redirect')
  ...
  response = await request('/sigec-candidaturas/00000000-0000-0000-0000-000000000000', candidate)
  assert(response.status === 307 && locationPath(response) === '/minha-area', 'candidate_sigec_application_detail_redirect')
  ...
  response = await request('/sigec-candidaturas/00000000-0000-0000-0000-000000000000')
  assert(response.status === 307 && locationPath(response) === '/login', 'anonymous_sigec_application_detail_redirect')
